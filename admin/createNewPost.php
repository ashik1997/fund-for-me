...
$sql_add_event = "INSERT INTO event(title,description,donation_amount,expire_date,image,pdf,user_email,status,cat_id)
VALUES ('$title','$description','$donation_amount','$expire_date','$newfilename1','$newfilename2','admin',1,'$cat_id')";
// echo $sql;
